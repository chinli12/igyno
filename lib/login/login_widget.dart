...
class LoginWidget extends StatefulWidget {
  /// A loging screen for period tracking app
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            16.0, 16.0, 16.0, 16.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1533228100845-08145b01de14?w=500&h=500',
                                          width: 30.0,
                                          height: 30.0,
                                          fit: BoxFit.contain,
                                        ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            16.0, 16.0, 16.0, 16.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1724675708741-cb0a98ac296b?w=500&h=500',
                                          width: 30.0,
                                          height: 30.0,
                                          fit: BoxFit.contain,
                                        ),
